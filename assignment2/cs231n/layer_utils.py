...
def affine_bn_backward(dout, cache):
  ...
  da = batchnorm_backward(dout, bn_cache)
...
def conv_bn_relu_forward(x, w, b, conv_param, gamma, beta, bn_param):
  """
  Convenience layer that performs a convolution, spatial batch normalization, and a ReLU
...
def conv_bn_relu_backward(dout, cache):
  """
  Backward pass for the conv-spatial batch normalization-relu-pool convenience layer
  """
...
def conv_bn_relu_pool_forward(x, w, b, conv_param, pool_param, gamma, beta, bn_param):
  """
  Convenience layer that performs a convolution, spatial batch normalization, a ReLU, and a pool.
